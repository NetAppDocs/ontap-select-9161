...
* link:task_cli_migrate_deploy.html#restore-the-deploy-configuration-data-to-the-new-virtual-machine[Restore the Deploy configuration data to the new virtual machine]
* link:task_adm_licenses.html#reinstall-a-capacity-pool-license[Reinstall a Capacity Pool license]
